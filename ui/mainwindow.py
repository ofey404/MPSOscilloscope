...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.comboBox.setItemText(0, _translate("MainWindow", "Trigger"))
        self.comboBox.setItemText(1, _translate("MainWindow", "Cursor 1"))
        self.comboBox.setItemText(2, _translate("MainWindow", "Cursor 2"))
        self.label_5.setText(_translate("MainWindow", "Current Voltage Level"))
        self.zoomInButton.setText(_translate("MainWindow", "Toggle Visibility"))
