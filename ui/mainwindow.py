...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.updateConfig = QtWidgets.QPushButton(self.scrollAreaWidgetContents_2)
        self.updateConfig.setObjectName("updateConfig")
        self.verticalLayout_9.addWidget(self.updateConfig)
        ...
        self.deviceNumberComboBox = QtWidgets.QComboBox(self.scrollAreaWidgetContents_2)
        self.deviceNumberComboBox.setEditable(False)
        self.deviceNumberComboBox.setObjectName("deviceNumberComboBox")
        self.deviceNumberComboBox.addItem("")
        self.deviceNumberComboBox.addItem("")
        self.horizontalLayout_10.addWidget(self.deviceNumberComboBox)
        ...
        self.bufferSizeComboBox = QtWidgets.QComboBox(self.scrollAreaWidgetContents_2)
        self.bufferSizeComboBox.setEditable(True)
        self.bufferSizeComboBox.setObjectName("bufferSizeComboBox")
        self.bufferSizeComboBox.addItem("")
        self.bufferSizeComboBox.addItem("")
        self.horizontalLayout_11.addWidget(self.bufferSizeComboBox)
        ...
        self.sampleRateComboBox = QtWidgets.QComboBox(self.scrollAreaWidgetContents_2)
        self.sampleRateComboBox.setEditable(True)
        self.sampleRateComboBox.setObjectName("sampleRateComboBox")
        self.sampleRateComboBox.addItem("")
        self.sampleRateComboBox.addItem("")
        self.sampleRateComboBox.addItem("")
        self.sampleRateComboBox.addItem("")
        self.horizontalLayout_14.addWidget(self.sampleRateComboBox)
        ...
        self.restartDevice = QtWidgets.QPushButton(self.scrollAreaWidgetContents_2)
        self.restartDevice.setObjectName("restartDevice")
        self.verticalLayout_9.addWidget(self.restartDevice)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.updateConfig.setText(_translate("MainWindow", "Update Config"))
        ...
        self.deviceNumberComboBox.setItemText(0, _translate("MainWindow", "0"))
        self.deviceNumberComboBox.setItemText(1, _translate("MainWindow", "1"))
        self.label_10.setText(_translate("MainWindow", "Buffer Size"))
        self.bufferSizeComboBox.setItemText(0, _translate("MainWindow", "2048"))
        self.bufferSizeComboBox.setItemText(1, _translate("MainWindow", "4096"))
        ...
        self.label_8.setText(_translate("MainWindow", "ADC Range"))
        ...
        self.sampleRateComboBox.setItemText(0, _translate("MainWindow", "450000"))
        self.sampleRateComboBox.setItemText(1, _translate("MainWindow", "200000"))
        self.sampleRateComboBox.setItemText(2, _translate("MainWindow", "100000"))
        self.sampleRateComboBox.setItemText(3, _translate("MainWindow", "10000"))
        ...
        self.restartDevice.setText(_translate("MainWindow", "Restart Device"))
