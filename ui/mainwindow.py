...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.sliderVoltageDisplay = QtWidgets.QLCDNumber(self.gridLayoutWidget)
        self.sliderVoltageDisplay.setSmallDecimalPoint(False)
        self.sliderVoltageDisplay.setObjectName("sliderVoltageDisplay")
        self.horizontalLayout_8.addWidget(self.sliderVoltageDisplay)
